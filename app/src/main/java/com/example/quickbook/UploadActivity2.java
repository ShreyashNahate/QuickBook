...
public class UploadActivity2 extends AppCompatActivity {
    ...
    public void uploadData(){
        ...
        String x = intent.getStringExtra("caption");
        ...
        DataClass2 dataClass = new DataClass2(title,  imageURL,currentDate);
        FirebaseDatabase.getInstance().getReference(x).child(currentDate)
                .setValue(dataClass).addOnCompleteListener(new OnCompleteListener<Void>() {
                    ...
                    @Override
                    public void onFailure(@NonNull Exception e) {
                        Toast.makeText(UploadActivity2.this, e.getMessage().toString(), Toast.LENGTH_SHORT).show();
                    }
                });
    }
}